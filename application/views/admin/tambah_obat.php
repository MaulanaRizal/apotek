       ...
       <div class=row>
            ...
            <div class=container>
              <div class='box box-primary' style=width:94%;>
                ...
                <form action="<?=base_url('admin/tambah_obat')?>" role="form" method="post">
                <?php if(validation_errors()){ ?>
                  ...
                  <div class=box-body>
                    ...
                    <div class=col-md-2>
                      ...
                      <div class=col-md-6>
                        <input type="text" required class=form-control name=nama_obat>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class=box-body>
                    ...
                    <div class=col-md-2>
                      ...
                      <div class=col-md-6>
                        <input type="text" required class=form-control name=kode_obat>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class=box-body>
                    ...
                    <div class=col-md-2>
                      ...
                      <div class=col-md-6>
                        <input type="text" required class=form-control name=produsen_obat>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class=box-body>
                    ...
                    <div class=col-md-2>
                      ...
                      <div class=col-md-6>
                        <input type="text" required class=form-control name=distributor_obat>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class=box-body>
                    ...
                    <div class=col-md-2>
                      ...
                      <div class=col-md-6>
                        <input type="text" required class=form-control name=satuan_obat>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class=box-body>
                    ...
                    <div class=col-md-2>
                      ...
                      <div class=col-md-6>
                        <input type="number" required class=form-control name=harga_beli>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class=box-body>
                    ...
                    <div class=col-md-2>
                      ...
                      <div class=col-md-2>
                        <input type="date" required class=form-control name=tanggal_masuk>
                      </div>
                      ...
                      <div class=col-md-2>
                        <input type="date" required class=form-control name=tanggal_expired>
                      </div>
                    </div>
                  </div>
